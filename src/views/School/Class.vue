<template>
  <section>
    ...
    <!--列表-->
    <el-table :data="Clazz" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
      style="width: 100%">
    ...
    <!--新增界面-->
    <el-dialog title="新增班级" :visible.sync="addFormVisible" v-model="addFormVisible" :close-on-click-modal="false">
    ...
    <!--编辑界面-->
    <el-dialog title="编辑班级" :visible.sync="editFormVisible" v-model="editFormVisible" :close-on-click-modal="false">
